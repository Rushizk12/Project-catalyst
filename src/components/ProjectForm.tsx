      ...
      <section className="py-16 sm:py-20 text-center">
        <div className="max-w-3xl mx-auto bg-surface border border-border rounded-xl p-8 md:p-12">
          ...
          <p className="mt-4 text-lg text-text-secondary">
            Your project has been submitted successfully. I&apos;ll review the details and get back
            to you at <span className="font-semibold text-primary">{formData.email}</span> within
            the next 48 hours.
          </p>
        </div>
      </section>
    ...
    <section className="py-16 sm:py-20">
      ...
      <div className="mt-12 max-w-3xl mx-auto">
        <form
          ...
          className="space-y-6 bg-surface p-8 rounded-xl border border-border"
        >
          ...
          <FormInput
            ...
            onChange={handleInputChange}
            placeholder="e.g., E-commerce Platform for Books"
          />
            ...
            {analysisResult && (
              <div className="mt-4 p-4 bg-background border border-border rounded-lg">
                <h4 className="text-lg font-semibold text-text-primary flex items-center">
                  <AiSparkleIcon className="text-secondary mr-2" /> AI Analysis
                </h4>
                <div className="mt-2 space-y-2 text-text-secondary">
                  ...
                  <p>
                    <strong>Suggested Category:</strong> {analysisResult.category}
                  </p>
                  <p>
                    <strong>Estimated Complexity:</strong> {analysisResult.estimatedComplexity}
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-text-secondary mb-1"
              >
                Estimated Budget: {formatINR(Number(formData.budget))}
              </label>
              <input
                type="range"
                id="budget"
